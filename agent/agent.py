...
root_agent = LlmAgent(
    ...
    instruction = "\n".join([
        ...
        "Las únicas tools a las que tienes acceso son `search(keywords)` y `download(identifiers)`. NO PUEDES usar ninguna más."
            "NO HAY tools derivadas de estas. Por ejemplo, tools como `search.commentary` o `search<|channel|>commentary NO EXISTEN Y NO PUEDEN SER USADAS."
        "Pasos:",
        ...
        "3. Mirando el abstract de los artículos, elige entre 2 y 5 que sean relevantes."
            "Coger más artículos te supone más esfuerzo, así que REDUCIRÁS la cantidad de referencias a no ser que las referencias escogidas sean muy cortas o NECESITES escribir un informe largo",
